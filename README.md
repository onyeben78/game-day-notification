# NFL Game Day Notifications / Sports Alerts System
...
## **Features**
- Fetches live NFL game scores using an external API.
...
```bash
git clone https://github.com/onyeben78/game-day-notification
